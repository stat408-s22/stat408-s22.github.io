...
- [Lab 1](labs/lab-01/lab-01-hello-r.html) ([Rmd](labs/lab-01/lab-01-hello-r.Rmd)) - Due Monday, Jan 31 by 5pm in GitHub
...
1. Understand R data structures and basic "base R" graphics functions.
...
- Week 3 slides ([PDF](lectures/week3/week3-slides.pdf)) ([Rmd](https://raw.githubusercontent.com/stat408-s22/stat408-s22.github.io/main/lectures/week3/week3-slides.Rmd))

__In-class Lab:__

- [Lab 2](labs/lab-02/lab-02-plastic-waste.html) ([Rmd](labs/lab-02/lab-01-plastic-waste.Rmd)) - Due Monday, Feb 7 by 5pm in GitHub

__Homework:__

---

## Week 4 (Feb 7--11): Tidyverse Overview 

---

__Weekly Overview:__ 

1. Practice wrangling data with the tidyverse "verbs": `filter()`, `arrange()`, `select()`, `mutate()`, `summarise()`, `group_by()`
 
__Reading and Online Resources:__ 


- [Modern Dive Ch. 3](https://moderndive.com/3-wrangling.html)
- [R 4 DS Ch. 5](https://r4ds.had.co.nz/transform.html)
...
- [R 4 DS Ch. 4](https://r4ds.had.co.nz/workflow-basics.html)
